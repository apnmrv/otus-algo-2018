...
public class MSorterAllInOneOptimizedMultithreaded extends MSorter {

    private final InsertionSorter __iSorter;
    private int __insertionSortCutoff;


    MSorterAllInOneOptimizedMultithreaded(IMerger merger, InsertionSorter iSorter, int insertionSortCutoff) {
        super(merger);
