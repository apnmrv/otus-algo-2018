...
public class MSorterAllInOneOptimized extends MSorter {
    ...
    private static final String __TITLE = "MergeSort Optimized Implementation";

    private final InsertionSorter __iSorter;
    private int __insertionSortCutoff;


    public MSorterAllInOneOptimized(IMerger merger, InsertionSorter iSorter, int insertionSortCutoff) {
        super(merger);
